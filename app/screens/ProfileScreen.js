        ...
        <View style={styles.container}>
            ...
            <View style={styles.menuWrapper}>
                <TouchableOpacity style={styles.menuItem} onPress={() => {navigation.navigate('ChangePasswordScreen')}}>
                    <Icon name="account-key-outline" color="#5db075" size={25}/>
                    <Text style={styles.menuItemText}>Change Password</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.menuItem} onPress={() => {navigation.navigate('FiltersScreen')}}>
                    <Icon name="filter-outline" color="#5db075" size={25}/>
                    <Text style={styles.menuItemText}>My Filters</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.menuItem} onPress={() => {navigation.navigate('HelpScreen')}}>
                    <Icon name="information-outline" color="#5db075" size={25}/>
