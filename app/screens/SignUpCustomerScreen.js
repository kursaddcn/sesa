...
export default function SignUpCustomerScreen({navigation}) {
    ...
    function passController(){
        validateFormData()
        if (formDataValidation.nameError || formDataValidation.surnameError ||
                    formDataValidation.emailError || formDataValidation.passwordDataError || emailExistsError===true){
                    console.log(emailExistsError,"Alan4");
                    displayFormatError();
                }else{
                    addNewUser({
                        userName: name,
        ...
        <View style={styles.container}>
            <View style={styles.title}>
                <View style={{flexDirection:"row",alignItems:"center",flex:1}}>
                    ...
                    <Text style = {styles.titleText}>Customer Sign Up</Text>
                </View>
            </View>
            {/*INPUT FIELDS*/}
...
connect(mapStateToProps, mapDispatchToProps)(SignUpCustomerScreen)
